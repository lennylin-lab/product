package com.product.masterdata.core.utils;

import com.product.cloud.security.auth.PrincipalUser;
import com.product.masterdata.common.constant.HttpStatus;
...
/**
 * 安全工具（master-data 域内使用；identity SecurityUtils 的业务域裁剪版：本域无角色语义，
