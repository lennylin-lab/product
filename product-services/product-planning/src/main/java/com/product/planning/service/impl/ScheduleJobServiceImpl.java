...
import com.product.planning.mapper.ScheduleJobMapper;
...
public class ScheduleJobServiceImpl implements IScheduleJobService {
    ...
    public Long scheduleAllAsync(TaskAssignmentDTO taskAssignmentDTO) {
        ...
        boolean locked = redisDistributedLock.tryLock(PlanningLockKeys.Schedule.SUBMIT_LOCK_KEY, 0, 30, TimeUnit.SECONDS);
        if (!locked) {
        ...
        try {
            ...
            redisDistributedLock.unlock(PlanningLockKeys.Schedule.SUBMIT_LOCK_KEY);
        }
    }
